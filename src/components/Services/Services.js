...
function Services() {
  return (
    <div className='Services_container'>
      <Header />
      <div className='service_bg_image'></div>
      <div className='centered_boxes_container'>
        ...
        <div className='centered_box'>
          <div className='service_content'>
            <div className='service_icon'><img src='https://rival.team/upload/service/b5/e1/servises1.svg' alt=''></img></div>
            <div className='service_text'>
